"""English text strings for Spellbinder spellbook. Based on Warlocks implementation for now.
...
spellbinder_monster_classes_en = {
    1: 'Goblin',
    2: 'Ogre',
    3: 'Troll',
    4: 'Giant',
...
spellbinder_text_strings_en = {

    'gestureN': '{name} makes no gesture with {pronoun1form3} {handname}.',
    'gestureC': '{name} claps.',
    'gestureC2': '{name} flailingly half-claps with {pronoun1form3} {handname}.',
    'gestureD': '{name} points the digit of {pronoun1form3} {handname}.',
    'gestureF': '{name} wiggles the fingers of {pronoun1form3} {handname}.',
    'gestureP': '{name} proffers the palm of {pronoun1form3} {handname}.',
    'gestureS': '{name} snaps the fingers of {pronoun1form3} {handname}.',
    'gestureW': '{name} waves {pronoun1form3} {handname}.',
    'gestureT': '{name} stabs with {pronoun1form3} {handname}.',
    ...
    'stabSelf': "{name} decides against stabbing {pronoun1form2}self.",
    ...
    'castGenericHand': "{name} casts {spellname} at the monster {targetname} is summoning with {pronoun1form3} {handname}.",
    'castDelayedNobody': "{name} casts banked {spellname} at nobody.",
    'castDelayedPoM': "{name} casts banked {spellname} at {targetname}.",
    'castDelayedHand': "{name} casts banked {spellname} at the monster {targetname} is summoning with {pronoun1form3} {handname}.",
    ...
    'castConfusionResolved': "{targetname} looks a bit confused.",
    'castCharmMonsterWrongTargetType': "{targetname} ignores {name}'s appeal to {pronoun1form3} baser instincts.",
    ...
    'castFireballResolved': "A fireball strikes {targetname}, burning {pronoun1form2} for 5 damage.",
    'castFireballResistHeat': "A fireball strikes, and flames roar around {targetname}. {pronoun1form1} stands calmly in the inferno.",
