...
warlocks_spell_description_en = [
    ...
    Can be successfully cast at any target, including nobody (however, the Physical Shield is only granted if the target is a player or a monster). Cannot be delayed, cannot be made permanent.""",
    },
    { 'id': 2:, 'desc': """Affects the target with Magic Shield and Physical Shield for 1 turn. Magic Shield counters most spells cast at the target (except for Finger of Death) and negates Fire Storm and Ice Storm effects on the target. Physical Shield protects the target from attacks.
    ...
    Can be cast at a player or a monster. Can be delayed, cannot be made permanent.""",
    },
    { 'id': 3:, 'desc': """Affects the target with Magic Mirror for 1 turn. The Magic Mirror effect reflects all spells directed at the target back to the caster but does not affect other actions (monster attacks, stabs).
    ...
    { 'id': 12:, 'desc': """Grants Physical Shield to the target for 3 turns, starting with the cast turn.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, can be made permanent.""",
    },
    { 'id': 13:, 'desc': """Grants permanent Resist Heat effect to the target, starting with the cast turn. Targets affected by this status ignore all fire damage (Fireball, Fire Elemental attacks, Fire Storm).
    If the target is Fire Elemental, it is instantly destroyed and does not get to attack this turn.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, always permanent.""",
    },
    { 'id': 14:, 'desc': """Grants permanent Resist Cold effect to the target, starting with the cast turn. Targets affected by this status ignore all cold damage (Ice Elemental attacks, Ice Storm).
    If the target is Ice Elemental, it is instantly destroyed and does not get to attack this turn.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, always permanent.""",
    },
    { 'id': 15:, 'desc': """If the target is a monster, it cannot attack this turn.
    ...
    { 'id': 16:, 'desc': """If the target is a monster, it cannot attack this turn.
    If the target is a player, for the next turn both their hands repeat the same gestures.
    Is a mindspell, clashes with other mindspells (Paralysis, Maladroitness, Fear, Amnesia, Charm Monster, Charm Person).
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, can be made permanent.""",
    },
    { 'id': 17:, 'desc': """If the target is a monster, it cannot attack this turn.
    If the target is a player, for the next turn they cannot show gestures C, D, F, S in either hand.
    Is a mindspell, clashes with other mindspells (Paralysis, Maladroitness, Fear, Amnesia, Charm Monster, Charm Person).
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, can be made permanent.""",
    },
    { 'id': 18:, 'desc': """If the target is a monster, it cannot attack this turn.
    If the target is a player, for the next turn they have to show the same gesture with both hands.
    Is a mindspell, clashes with other mindspells (Paralysis, Maladroitness, Fear, Amnesia, Charm Monster, Charm Person).
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, can be made permanent.""",
    },
    { 'id': 19:, 'desc': """If the target is a monster, the caster becomes its controller and can command the monster (including the cast turn).
    ...
    { 'id': 20:, 'desc': """If the target is a monster, the spell has no effect.
    ...
    { 'id': 21:, 'desc': """If the target is a monster, it dies at the end of the cast turn, after attacks.
    ...
    { 'id': 22:, 'desc': """Same as Disease, except cannot be cured by Cure Serious Wounds.
    ...
    { 'id': 23:, 'desc': """Heals target for 1 HP, respecting target max HP.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, cannot be made permanent.""",
    },
    { 'id': 24:, 'desc': """Heals target for 2 HP, respecting target max HP. Removes Disease effect from the target.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, cannot be made permanent.""",
    },
    { 'id': 25:, 'desc': """If the target is a monster, the spell has no effect.
    ...
    { 'id': 26:, 'desc': """If the target is a monster, it is instantly destroyed and does not get to attack this turn.
    ...
    { 'id': 27:, 'desc': """If the target is a monster, it is instantly destroyed and does not get to attack this turn.
    ...
    { 'id': 28:, 'desc': """If the target is a monster, this spell has no effect.
    ...
    { 'id': 30:, 'desc': """If the target is a monster, all "enchantment" effects affecting this monster are immediately removed, and the monster dies after attack.
    ...
    Can be countered. Can be delayed, cannot be made permanent.""",
    },
    { 'id': 31:, 'desc': """Grants Physical Shield to the target for 1 turn, starting with the cast turn.
    Can be successfully cast at monsters (including newly summoned) and players. Cannot be countered (but since Counterspell also provides a Shield, that does not affect anything). Can be delayed, cannot be made permanent.""",
    },
    { 'id': 32:, 'desc': """Deals 1 physical damage to any target. Is negated by the Physical shield effect.
    Can be successfully cast at monsters (including newly summoned) and players. Cannot be countered (but since Counterspell also provides a Shield, the damage is not done anyway). Can be delayed, cannot be made permanent.""",
    },
    { 'id': 33:, 'desc': """Deals 2 magical damage to any target.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, cannot be made permanent.""",
    },
    ...
    { 'id': 37:, 'desc': """Deals 5 magic damage to any target. Can be cast only once each match.
    Can be successfully cast at monsters (including newly summoned) and players. Can be countered. Can be delayed, cannot be made permanent.""",
    },
    { 'id': 38:, 'desc': """Kills any target at the end of the turn (after attacks).
    Can be successfully cast at monsters (including newly summoned) and players. Cannot (!) be countered. Can be delayed, cannot be made permanent.""",
    },
    { 'id': 39:, 'desc': """Deals 5 fire damage to all alive monsters and players (that are not protected by Magic Shield or Resist Heat effects), ignoring visibility. Instantly absorbs Fire Elemental (it does not get to attack this turn). Instantly absorbs and is negated by Ice Elemental (it does not get to attack this turn). Is negated by Ice Storm.
    Always cast at nobody. Cannot be countered (but the target of the CounterSpell ignores Storm damage due to the Magic Shield effect). Can be delayed, cannot be made permanent.""",
    },
    { 'id': 40:, 'desc': """Deals 5 ice damage to all alive monsters and players (that are not protected by Magic Shield or Resist Cold effects or were hit by Fireball this turn), ignoring visibility. Instantly absorbs Ice Elemental (it does not get to attack this turn). Instantly absorbs and is negated by Fire Elemental (it does not get to attack this turn). Is negated by Fire Storm.
    Always cast at nobody. Cannot be countered (but the target of the CounterSpell ignores Storm damage due to the Magic Shield effect). Can be delayed, cannot be made permanent.""",
    },
]
