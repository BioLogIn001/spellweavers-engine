...
warlocks_text_strings_en = {
    ...
    'gestureN': '{name} makes no gesture with {pronoun3} {handname}.',
    'gestureC': '{name} claps.',
    'gestureC2': '{name} flailingly half-claps with {pronoun3} {handname}.',
    'gestureD': '{name} points the digit of {pronoun3} {handname}.',
    'gestureF': '{name} wiggles the fingers of {pronoun3} {handname}.',
    'gestureP': '{name} proffers the palm of {pronoun3} {handname}.',
    'gestureS': '{name} snaps the fingers of {pronoun3} {handname}.',
    'gestureW': '{name} waves {pronoun3} {handname}.',
    'gestureT': '{name} stabs with {pronoun3} {handname}.',

    'resultActorDies': '{name} dies.',
    'resultActorSurrenders': '{name} surrenders.',
    'resultActorSuicides': "{name} stops {pronoun3} heart through force of will alone.",
    ...
    'effectCharmPerson1': "{targetname} is charmed into making the wrong gesture with {pronoun3} {handname}.",
    'effectCharmPerson2': "{name} is charmed, but ends up making the gestures {pronoun1} intended anyway!",

    'effectMindSpellCancel': '{targetname} shakes {pronoun3} head and regains control, as enchantments cancel each other out.',
    ...
    'castGenericHand': "{name} casts {spellname} at the monster {targetname} is summoning with {pronoun3} {handname}.",
    'castDelayedNobody': "{name} casts banked {spellname} at nobody.",
    'castDelayedPoM': "{name} casts banked {spellname} at {targetname}.",
    'castDelayedHand': "{name} casts banked {spellname} at the monster {targetname} is summoning with {pronoun3} {handname}.",
    ...
    'castCharmMonsterWrongTargetType': "{targetname} ignores {name}'s appeal to {pronoun3} baser instincts.",
    ...
    'castFireballResolved': "A fireball strikes {targetname}, burning {pronoun2} for 5 damage.",
    'castFireballResistHeat': "A fireball strikes, and flames roar around {targetname}. {pronoun1} stands calmly in the inferno.",
